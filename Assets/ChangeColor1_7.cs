...
public class ChangeColor1_7 : MonoBehaviour
{
  Material mat0;
  Material mat1;
  Material mat2;
  ...
  void Start()
  {
    ...
    mat6 = transform.GetChild(6).gameObject.GetComponent<Renderer>().material;
  ...
  {
    mat6.color = Color.red;
  }

  public void resetColor6()
  {
    mat6.color = defaultColor;
  }
}
